...
export const selfHostedProvider: SyncProviderClient = {
  ...
  deleteRemoteBlob,
  getCloudAuthStatus,
  listOrgMemberships: async () => [],
  listSharedVaultsByOrg: async () => null,
  listOrgMemberDevices: async () => [],
  registerOrgDeviceKey: async () => null,
  shareVaultWithOrg: async () => null,
  refreshSharedVaultAccess: async () => null,
  unshareVaultFromOrg: async () => null,
  openSharedVault: async () => null,
  pullSharedVaultSnapshot: async () => null,
  pushSharedVaultSnapshot: async () => null,
  putSharedBlob: async () => null,
  getSharedBlob: async () => null,
  deleteSharedBlob: async () => null,
